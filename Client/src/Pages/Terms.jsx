...
export default function Terms(){
    return(
        <div className="flex justify-center w-full h-full">
            <div className="flex w-2/3 mt-3 gap-6 max-h-screen overflow-y-auto">
                <div className="w-1/4 div-color max-h-[350px] p-4 rounded-lg">
                    <div className="text-xl text4">
                        Table of Contents
                    </div>
                    ...
                    "Contact Us"].map((item,index)=>(
                        <div key={index} className="mb-2 hover:text-red-600 cursor-pointer transition duration-900 text-gray text-sm">
                            {item}
                        </div>
                    ))
