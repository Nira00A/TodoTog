...
function ProfilePage() {
  ...
  return (
    <div className="w-full h-full flex justify-center relative">
      <div className="w-[1150px] flex relative max-navlg:flex-col max-navlg:items-center max-navlg:gap-3 max-navlg:w-full p-3 pt-6 overflow-y-scroll scrollbar-none">
        {/**Profile card*/}
        <div className="w-[28%] flex flex-col gap-4 background-color relative max-navlg:w-full">
          <div className="w-[95%] h-max p-3 div-color rounded-md relative max-navlg:w-full max-navlg:flex max-[610px]:flex-col">
            ...
            <div className="w-full flex justify-center items-center pb-3 relative max-navlg:justify-end max-[610px]:hidden">
              <div className="rounded-xl w-[95%] h-14 p-2 mt-3 flex justify-between items-center overlay-color max-navlg:h-[90%] max-navlg:w-[150px] max-navlg:hidden">
                <div>
                  <div className="text-4xl font-[500] text4">12</div>
                  <div className="text-[10px] text-gray text-red">
                    Today's Streak
                  </div>
                </div>
                <svg
              ...
              <div className="hidden h-[70%] rounded-lg w-28 relative max-navlg:flex">
                ...
                <div className="text4 absolute top-[62%] left-[42%]">12</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-[70%] h-full gap-4 flex flex-col items-center background-color max-navlg:w-full">
          <div className="w-[100%] div-color p-3 rounded-md">
            ...
            <div className="flex flex-wrap mt-3 gap-4 max-navlg:w-full">
              <TaskCard />
              <TaskCard />
              <TaskCard ishidden={true}/>
              <TaskCard ishidden={true}/>
            </div>
          </div>
          ...
          <div className="w-[100%] flex gap-4 max-navlg:flex-col max-navlg:overflow-hidden">
            <div className="h-[445px] w-[50%] p-3 rounded-md div-color max-navlg:w-full max-navmd:h-[250px]">
              ...
              <div className="w-[100%] h-[80%] flex flex-col justify-center items-center ">
                ...
                <div className="w-[100%] text-gray text-[12px] text-center">
                  No Projects have been added please create a one first
                </div>
              </div>
            </div>
            <div className="w-[50%] p-5 rounded-md div-color max-navlg:w-full">
              ...
              <div className="h-max flex flex-wrap gap-3 max-navlg:flex-nowrap">
...
function TaskCard({ishidden}) {
  return (
    <div
      style={{ backgroundColor: "var(--popup-color)" }}
      className={`${ishidden ? "max-navmd:hidden" : ""} h-[70px] min-w-[324px] flex items-center p-1 rounded-lg max-navlg:min-w-[48%] max-navmd:min-w-full`}
    >
      <div className="h-10 w-10 ml-4 rounded-md overlay-color"></div>
      ...
      <div className="flex w-72 justify-between max-navlg:w-[90%] max-navlg:pr-3">
        ...
        <div className="">
          <div className="text-[10px] text-gray">10 min ago</div>
...
function AchievementCard({ img, name }) {
  return (
    <div
      style={{ backgroundColor: "var(--popup-color)" }}
      className="flex flex-col justify-center items-center h-[160px] w-[150px] rounded-lg overflow-hidden mt-3 relative 
      max-navlg:w-full max-navlg:flex-row max-navlg:h-max max-navlg:p-3 max-navlg:justify-start max-navlg:gap-3
    ...
    >
      ...
      <div className="text4 text-xs mt-3 max-navlg:mt-0 max-navmd:hidden">Newbie</div>
    </div>
  );
}
